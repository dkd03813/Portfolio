        ...
        <div data-aos="fade">
          <div className="container  sm:px-5 md:px-10 lg:px-20">
            <div className="py-12 px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-x-6 gap-y-6 ">
                <ResumeCard />
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1  md:grid-cols-2 gap-8">
              ...
              <div className="col-span-1">
                ...
                <div className="flex gap-x-3 gap-y-3 md:gap-y-6 md:gap-x-4 flex-wrap">
                  ...
                  <button className="resume-btn">Microsoft Suite</button>
                  <button className="resume-btn">Agile Environment</button>
                  <button className="resume-btn">Scrum Experience</button>
                  <button className="resume-btn">Software Testing</button>
                  <button className="resume-btn">Waterfall Methodology</button>
                  <button className="resume-btn">Problem Solving</button>
                  <button className="resume-btn">Communication</button>
                  <button className="resume-btn">Collaboration</button>
                  <button className="resume-btn">Adaptability</button>
                  <button className="resume-btn">Time Management</button>
                  <button className="resume-btn">Continuous Learning</button>
                </div>
              </div>
            </div>
          </div>
