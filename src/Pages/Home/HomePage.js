...
const HomePage = () => {
  return (
    <>
      ...
      >
        <img
  className="rounded-full w-[250px] h-[250px] 2xl:w-[280px] 2xl:h-[280px] object-cover"
  src={userImage}
  alt="User Profile"
/>
        ...
        <p className="mb-4 text-[#7B7B7B]">Full Stack Web Developer</p>
        {/* Avatar Info End */}

        {/* Social information start */}
        <div className="flex space-x-3">
          <a
            href="https://github.com/dkd03813"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/damian-diaz-97578121a"
            target="_blank"
            rel="noopener noreferrer"
          >
